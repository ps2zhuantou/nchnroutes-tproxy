produce:
	...
	curl -o delegated-apnic-latest https://ftp.apnic.net/stats/apnic/delegated-apnic-latest
        #curl -o china_ip_list.txt https://chnroutes2.cdn.skk.moe/chnroutes.txt
	    #curl -o china_ip_list.txt https://github.com/misakaio/chnroutes2/raw/refs/heads/master/chnroutes.txt
